...
### 🚀**News**: The 25 processed datasets have been uploaded to [ModelScope](https://www.modelscope.cn/datasets/GoodBaiBai88/M3D-Seg/summary)(魔搭社区) and [HuggingFace](https://huggingface.co/datasets/GoodBaiBai88/M3D-Seg).
